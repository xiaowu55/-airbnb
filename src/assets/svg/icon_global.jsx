...
const IconGlobal = memo(() => {
  return (
    <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={cssToObj("display: block; height: 16px; width: 16px; fill: currentcolor;")}>
